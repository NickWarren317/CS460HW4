...
# Load the map
map_trial = "Maze2Trial3.pgm"
map_path = f'/home/nickwarren/RoboticsFinalProj/CS460HW4/mapcode/data/{map_trial}'  # Replace with your map file path
...
histogram_path = os.path.join(os.path.dirname(map_path), f'{map_trial}_histogram.png')
...
map_visualization_path = os.path.join(os.path.dirname(map_path), f'{map_trial}_visualization.png')
